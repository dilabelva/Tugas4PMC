/*
Tugas 4 : Pengaplikasian Algoritma Dijkstra
Nama    : Atadila Belva Ganya
NIM     : 18320015
Jurusan : Teknik Biomedis'20

Code sumber: Tugas 7 Kelompok 5
...
int main (){
    ...
    // Input file tanaman
    printf("Selamat datang di database Kota-Kota Indonesia.\n");
    printf("Silahkan masukkan nama file sebagai database nama-nama kota di Indonesia: ");
    ...
    printf("Pembacaan nama-nama kota di Indonesia berhasil.\n");
    printf("Terdapat %d nama kota Indonesia dalam database.\n",n_tanaman);
    ...
    while(progress=='y'){
        ...
        printf("\nBerikut adalah daftar nama kota-kota yang berada di Indonesia.\n");
        ...
        printf("Apakah anda masih ingin mengelilingi kota-kota di Indonesia? [y/n]: ");
        scanf(" %c",&progress);
    }
}
